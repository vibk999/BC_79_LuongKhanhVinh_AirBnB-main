...
export default function Header() {
  ...
  return (
    ...
    >
      <Toolbar
        sx={{ py: isMobile ? 1.25 : 2.5, minHeight: { xs: 56, sm: 64 } }}
      >
        <Box sx={{ flexGrow: 1, display: "flex", alignItems: "center" }}>
          <NavLink
            to="/"
            className="flex items-center text-rose-500 active header-search"
          ...
          >
            ...
            >
              <Box
                sx={{
                  display: {
                    xs: showLocationDropdown ? "flex" : "none",
                    md: "none",
                  },
                  flexWrap: "wrap",
                  justifyContent: "center",
              ...
              <Box
                onClick={toggleLocationDropdown}
                sx={{
                  display: showLocationDropdown ? "none" : "flex",
                  flexWrap: "wrap",
                  px: 3,
                  py: 1.5,
                  borderRadius: "full",
              ...
              >
                <Typography
                  variant="subtitle2"
                  fontWeight="medium"
                  sx={{ pr: 2, borderRight: 1, borderColor: "divider" }}
                >
                  Địa điểm bất kỳ
                </Typography>
                <Typography
                  variant="subtitle2"
                  fontWeight="medium"
                  sx={{ px: 2, borderRight: 1, borderColor: "divider" }}
                >
                  Tuần bất kỳ
                </Typography>
        ...
        <Box sx={{ display: { xs: "none", sm: "flex" }, alignItems: "center" }}>
          <Link
            ...
            color="inherit"
            underline="none"
            sx={{ mr: 2, display: { lg: "block", xs: "none" } }}
          >
            <Button color="inherit">Trở thành chủ nhà</Button>
          </Link>
          <IconButton sx={{ mr: 2, display: { lg: "block", xs: "none" } }}>
            <LanguageIcon />
          </IconButton>
          <HeaderProfile />
        </Box>
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <Box
                  sx={{ py: 1, px: 2, borderLeft: 1, borderColor: "divider" }}
                >
                  <Typography
                    component="label"
                    htmlFor="checkInDate"
                ...
                <Button
                  ...
                  variant="contained"
                  color="primary"
                  sx={{ borderRadius: "full", mr: 1 }}
                >
                  <SearchIcon />
                </Button>
              </Box>
              <Box sx={{ display: { xs: "flex", md: "none" }, pr: 1 }}>
                <IconButton
                  onClick={handleSearchClick}
                  color="primary"
                  sx={{ borderRadius: "50%" }}
