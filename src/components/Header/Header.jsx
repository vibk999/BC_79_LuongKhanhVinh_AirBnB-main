  ...
  return (
    <nav className="fixed top-0 border-b w-full bg-white z-20">
      <div className="container mx-auto px-2 sm:px-10 py-5 max-sm:py-10 flex  justify-between items-center">
        ...
        <div
          className={`absolute top-0 left-0 w-screen bg-white transition-all duration-300 pb-3 z-10 absolute top-0 left-0 w-screen bg-white transition-all duration-300 pb-3 z-10  shadow-lg ${
